...
export default class Card extends Component{
	...
	render(){
		...
		if(0!=this.props.index && 0===this.props.index%5 && true===this.props.displayList){
			listedInstance = "</tr><tr>";
		}
		if(true === this.props.faceUp){
			return (<div><div className={"card " + isSelected} title={this.props.description} onClick={this.props.onClick}>
