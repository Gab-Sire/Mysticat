	...
	render(){
		...
		if(true === this.props.faceUp){
			return (<div className={"card " + isSelected} title={this.props.description} onClick={this.props.onClick}>
				<div className='cardManaContainer' title="The amount of mana crystals consumed when summoning this minion"><div className="cardManaCost">{this.props.manaCost}</div></div>
