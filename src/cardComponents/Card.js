	...
	render(){
		...
		if(true === this.props.faceUp){
			return (<div className={"card"+listedInstance + isSelected} title={this.props.description} onClick={this.props.onClick}>
				...
				<div title="The amount of damage this minion deals" className={'cardDetailContainer cardPower'+listedInstance}><div className="balancingDetail">{this.props.initialPower}</div></div>
				<div title="The amount of damage this minion can take" className={'cardDetailContainer cardHealth'+listedInstance}><div className="balancingDetail">{this.props.initialHealth}</div></div>
				<div title="Speed dictates the order in which attacks resolve" className={'cardDetailContainer cardSpeed'+listedInstance}><div className="balancingDetail">{this.props.initialSpeed}</div></div>
			</div>);
