...
public class AuthentificationService {
    ...
    public void insertCustomCardsInDatabase() {
    	...
    	MinionCard minionCard01 = createMinionCard("Chat Momie", 3, 4, 3, 1, "La mal�diction du pharaon", "../img/cardImg/halloweenSetCards/chat_momie.jpg");
    	...
    	MinionCard minionCard08 = createMinionCard("FrankenChat", 7, 8, 5, 3, "Combien de vies de chats en �change de cette cr�ature ?", "../img/cardImg/halloweenSetCards/frankenchat.jpg");
